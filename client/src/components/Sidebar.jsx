function Sidebar({ sidebarOpen, toggleSidebar }) {
  ...
  return (
    <>
      ...
      <div className={`fixed inset-y-0 left-0 bg-base-100 z-50 w-1/2  transform ${ sidebarOpen ? "translate-x-0" : "-translate-x-full" } transition-transform duration-300 ease-in-out lg:hidden`}>
        <div className="p-2">
